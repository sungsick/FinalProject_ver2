...
//        List<WebElement> reviewElements = driver.findElements(By.className(".review")); // 리뷰박스를 감싸는 클래스
//
//        for (WebElement reviewElement : reviewElements) {
//
//            driver.get(String.valueOf(reviewElement));
//
//            WebElement imgElement = driver.findElement(By.cssSelector("div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > img")); // 별 이미지
//
