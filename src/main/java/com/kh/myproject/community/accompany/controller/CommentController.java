...
public class CommentController {
    ...
    public Comment commentEdit(Model model,
    ...
    @ResponseBody
    @PostMapping("/community/accompany/detail")
    public String commentDelete(@RequestParam("co_number") Long co_number,
                                Model model){
        ...
        Comment commentEntity = commentRepository.findById(co_number).orElse(null);
        System.out.println(commentEntity.toString());

        if(commentEntity != null) {
            commentRepository.delete(commentEntity);

            model.addAttribute("comentDelMsg", co_number + "번 댓글 삭제 완료!");
        }
