...
INSERT INTO `user` (`user_id`, `user_name`, `user_password`, `user_phone`, `user_gender`, `user_date`, `user_mbti`,
                    `user_img`, `user_regdate`)
VALUES ('john_doe', 'JohnDoe', 'password123', '01012345678', 'M', '1998-08-21', 'ENTJ', 'default1.png',
        '2023-08-21 12:34:56'),
       ('jane_smith', 'JaneSmith', 'pass4321', '01098765432', 'F', '2000-08-21', 'INFP', 'default2.png',
        '2023-08-22 09:15:30'),
       ('alex_brown', 'AlexBrown', 'securepwd', '01055555555', 'M', '1960-08-21', 'INTJ', 'default1.png',
        '2023-08-23 18:27:45'),
       ('test', 'yeong', '1234', '01012345678', 'M', '2023-08-21', 'INTJ', 'default1.png', '2023-08-24 14:22:10'),
       ('sample@example.com', '샘플', '1234', '01055555555', 'M', '1970-08-21', 'INTJ', 'default1.png',
        '2023-08-25 20:45:00'),
       ('user1', 'UserOne', 'userpass1', '01011111111', 'F', '1967-08-21', 'ISFJ', 'default2.png',
        '2023-08-26 07:30:20'),
       ('user2', 'UserTwo', 'userpass2', '01022222222', 'M', '1978-08-21', 'ESTP', 'default1.png',
        '2023-08-26 16:15:55'),
       ('user3', 'UserThree', 'userpass3', '01033333333', 'F', '1956-08-21', 'ENFP', 'default2.png',
        '2023-08-26 22:10:45'),
       ('user4', 'UserFour', 'userpass4', '01044444444', 'M', '1999-08-21', 'ISTJ', 'default1.png',
        '2023-08-29 11:05:30'),
       ('user5', 'UserFive', 'userpass5', '01055555555', 'F', '2023-08-21', 'ESFP', 'default2.png',
        '2023-08-30 19:20:15'),
       ('user6', 'UserSix', 'userpass6', '01066666666', 'M', '2023-08-21', 'INTJ', 'default1.png',
        '2023-08-31 12:00:00'),
...
VALUES ('john_doe', '제목1', '내용은 이것입니다1.', '답변은 아직입니다1.', now()),
...
VALUES ('더 뉴 레이', '20년식 ', '국내', '경형', '디젤', '21세 이상', 4, 100000, 25000, 1, '옵션없음', 'ray.png'),
       ...
       ('카니발', '17년식', '국내', '승합', '디젤', '26세 이상', 7, 200000, 70000, 1, '블랙박스, 내비게이션', 'canival.png'),
       ('캐스퍼', '18년식', '국내', '경형', '디젤', '21세 이상', 5, 250000, 78000, 2, '옵션없음', 'casper.png'),
       ('더 뉴 스파크', '21년식', '국내', '경형', '경유', '26세 이상', 5, 200000, 70000, 2, '블랙박스, 내비게이션', 'spark.png'),
       ('더 뉴 아반떼', '18년식', '국내', '승용', '가솔린', '26세 이상', 5, 200000, 87000, 3,
        '내비게이션, 열선시트, 블랙박스, 선루프, 운전석 에어백, 금연차량', 'avantte.png'),
       ('쏘나타', '16년식', '국내', '승용', 'LPG', '26세 이상', 5, 180000, 75000, 4, '블랙박스, 내비게이션', 'sonata.png'),
       ('코나', '22년식', '국내', 'SUV', '가솔린', '21세 이상', 4, 100000, 25000, 5, '옵션없음', 'cona.png'),
       ('더 뉴 스타렉스', '21년식', '국내', '승합', '디젤', '26세 이상', 9, 250000, 98000, 6,
