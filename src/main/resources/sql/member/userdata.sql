...
VALUES
    (1, '안녕하세요 저는 1번입니다.', 1, '2023-08-01 14:10:41'),
    (2, '나는 1번입니다.', 1, NOW()),
    (3, '얘가 더 빠른 메시지이다.', 3, '2023-09-01 14:10:41'),
    (4, '메시지 내용 4', 4, NOW()),
    (5, '메시지 내용 5', 5, NOW()),
    (1, '안녕하세요 저는 2번입니다.', 2, '2023-09-08 14:10:41'),
    (2, '나는 4번입닌다.', 4, NOW()),
    (3, '얘가 최근 메시지다.', 3, NOW()),
    (3, '이건 test가 보낸 메시지이다. 가장 최근의 앞 메시지이다.', 1,'2023-09-07 14:10:41'),
    (4, '메시지 내용 4', 4, NOW()),
    (5, '메시지 내용 5', 5, NOW()),
    (9, '메시지 내용 5', 5, '2023-09-06 14:10:41');